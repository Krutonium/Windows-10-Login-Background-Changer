...
namespace W10_Logon_BG_Changer
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        public MainWindow()
        {
            ...
            Settings.Init(Config.SettingsFilePath, new DesEncrpytion("W10Login", "W10Login"));
            ...
            HelperLib.TakeOwnership(Config.LoginFolder);
            HelperLib.TakeOwnership(Config.PriFileLocation);

            if (!File.Exists(Config.BakPriFileLocation))
            {
                Debug.WriteLine("[Warning]: Could not find Windows.UI.Login.pri.bak file. Creating new.");
